...
t7.module(function(t7) {
    ...
    render() {
        ...
        if (this.props.rows) {
          this.props.rows.forEach(function (row) {
            rows.push(
              t7.precompile([row.status, row.name, row.email, row.field1, row.field2, row.field3, row.field4, row.field5, row.field6Data, row.field7, row.field8, row.field9, row.field10, {template: __EqdY5,templateKey: 1297586528, components: null}])
            );
          });
        }
        return t7.precompile([rows, {template: __OZVy3,templateKey: 1229343019, components: null}]);
    }
  }
  ...
  class Header extends Inferno.Component {
    ...
    render() {
        return t7.precompile([this.props.running, this.handleClick.bind(this, 500), this.props.running, this.handleClick.bind(this, 1500), this.props.running, this.handleClick.bind(this, 2500), this.props.running, this.handleClick.bind(this, 5000), this.props.duration || "", {template: __N2t8B,templateKey: -2028456066, components: null}]);
    }
  }
  ...
  class TestApp extends Inferno.Component {
    ...
    runTest(counter) {
      ...
      Inferno.render(
        t7.precompile([[], {template: __SU73I,templateKey: 312192015, components: null}]),
      ...
      $.ajax({
          ...
          success: function (data) {
              ...
              Inferno.render(
                t7.precompile([this.state.rows, {template: __SU73I,templateKey: 312192015, components: null}]),
                document.getElementById("table")
              );
    ...
    render() {
      return t7.precompile([this.runTest, this.state.running, this.state.duration, {template: __CCaH9,templateKey: 1392273188, components: null}]);
    }
  }
  ...
  Inferno.render(
    t7.precompile([{template: __tTr0y,templateKey: -1535803172, components: null}]),
